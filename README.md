# Anvil-Lite: A Lightweight RISC-V Processor
## Overview
Anvil-Pro is a RISC-V RV32EC + Zicsr + Zifencei + Zcb + Zcmp + Zcmt softcore optimized for FPGA platforms. The core supports M-mode execution, strict Harvard memory architecture, and a Wishbone Classic data interface for external memory integration.
